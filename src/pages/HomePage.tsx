	...
	return (
		<div className="page" id="home">
			<div className="page-panel">
				...
				<p>
					<a className="link" href="https://github.com/hacker30083/tt/blob/main/README.md">README.md</a><br />
					<a className="link" href="https://github.com/hacker30083/tt">GitHub</a><br />
